...
public class AdapterFishing extends RecyclerView.Adapter<AdapterFishing.ViewHolder> {
    ...
    public AdapterFishing(List<VideoModel> listVideo, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       View view= LayoutInflater.from(context).inflate(R.layout.item_fishing,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            txtTitle=(TextView) itemView.findViewById(R.id.tv_TitleFishing);
            txtTime=(TextView) itemView.findViewById(R.id.tv_TimeFishing);
            imageView=(ImageView) itemView.findViewById(R.id.img_viewFishing);
